...
Если верить вики, то впервые эта функция засветилась еще в трудах Диофанта, а позже, в 17 веке, ей заинтресовался сам Ньютон. Его исследования во многом привели к формулам сложения точек на эллиптической кривой, с которыми мы сейчас познакомимся. Здесь и в дальнейшем мы будем рассматривать некоторую эллиптическую кривую $\alpha$.
...
Постараемся его представить: согласно [этой статье](http://www.quickanddirtytips.com/education/math/how-many-grains-of-sand-are-on-earth%E2%80%99s-beaches), на всей Земле немногим меньше $10^{22}$ песчинок. Воспользуемся тем, что $2^{10} ≈ 10^3$, то есть $10^{22} ≈ 2^{80}$ песчинок. А всего адресов у нас $2^{256}$, примерно ${2^{80}}^3$.
